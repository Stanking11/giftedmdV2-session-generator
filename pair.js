...
_Don't Forget To Give Star To My Repo_`
 await Pair_Code_By_Stany_Tech.sendMessage(Pair_Code_By_Stany_Tech.user.id,{text:STANY_TECH_MD_TEXT},{quoted:session})
 

        await delay(100);
        await Pair_Code_By_Stany_Tech.ws.close();
    ...
    return await STANY_TECH_XMD_PAIR_CODE()
});
